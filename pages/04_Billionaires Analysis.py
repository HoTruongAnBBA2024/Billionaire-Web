...
# --- Main Title ---
st.markdown("""
## Global Billionaires Distribution Visualization""")
...
with header_left:
  st.subheader("Top 6 Industries With Most Billionaires")
...
with left:
  ...
  st.markdown(f"""
       #### Total Billionaires: {total_billionaires}""")
...
st.markdown("<hr style='border: 2px solid gray;'>", unsafe_allow_html=True)
st.markdown("""
## The Billionaire Blueprint In Nations""")
...
highlight1_text = "Explore how billionaire wealth is built—sector by sector, across the world's six economic powerhouses."
highlight1_label = None
highlight_color = "#CEAB93"
highlight1_text_color = "black"


text_part2 = "Some countries, like the U.S. and China, dominate through innovation in technology and manufacturing. Others, such as Germany and Italy, continue to build wealth through legacy industries known for quality and heritage.\n\nThis visual comparison reflects the economic DNA of each nation—where tradition meets transformation, and where new fortunes rise.\n\n"
highlight2_text = "From generational dynasties to self-made disruptors, these visuals uncover the industries fueling the next wave of global wealth."
highlight2_label = None
highlight2_text_color = "black"


# Use annotated_text to display the content
annotated_text(
   (f"**{highlight1_text}**", highlight1_label, highlight_color, highlight1_text_color),
   text_part1,
   text_part2,
...
Whether you're an economist, entrepreneur, student, or simply curious — let this analysis be a reminder: the future of wealth is already being written in the data where we explore today.
